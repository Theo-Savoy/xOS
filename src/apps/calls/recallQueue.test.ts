...
describe('recallQueue', () => {
  ...
  it('filters recall dates', () => {
    expect(matchesRecallDateFilter('2026-07-11', 'today', '2026-07-11')).toBe(
      true,
    );
    expect(matchesRecallDateFilter('2026-07-10', 'overdue', '2026-07-11')).toBe(
      true,
    );
    expect(
      matchesRecallDateFilter('2026-07-12', 'upcoming', '2026-07-11'),
    ).toBe(true);
    expect(matchesRecallDateFilter('2026-07-12', 'today', '2026-07-11')).toBe(
      false,
    );
  });
