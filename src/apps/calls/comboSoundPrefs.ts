...
export type ComboSoundGroup =
  'log' | 'rdv' | 'result' | 'navigation' | 'warn' | 'demo';
...
function pickKnownGroups(
  source: Partial<ComboSoundPrefs>,
): Partial<ComboSoundPrefs> {
...
export function isSoundGroupEnabled(
  group: ComboSoundGroup,
  masterEnabled = readSoundsEnabled(),
): boolean {
