...
export function CleanerIcon({ className }: IconProps) {
  return (
    <IconShell className={className}>
      <path
        d="M24 6.5 41.5 24 24 41.5 6.5 24 24 6.5Z"
        fill="currentColor"
        opacity=".18"
      />
      <path d="M24 11 37 24 24 37 11 24 24 11Z" fill="currentColor" />
      <path
        d="m18 24 4.4 4.4L31.5 19"
        stroke="white"
        strokeOpacity=".78"
        strokeWidth="3"
        strokeLinecap="round"
...
export function CallsIcon({ className }: IconProps) {
  return (
    <IconShell className={className}>
      ...
      />
      <path
        d="M30 12.5c3 .8 5.7 3.5 6.5 6.5"
        stroke="white"
        strokeOpacity=".58"
        strokeWidth="2.4"
        strokeLinecap="round"
      />
      <path
        d="M31.5 6.8c5.2 1.2 9.4 5.4 10.6 10.7"
        stroke="white"
        strokeOpacity=".32"
        strokeWidth="2.2"
        strokeLinecap="round"
...
export function HubIcon({ className }: IconProps) {
  return (
    <IconShell className={className}>
      <path
        d="M24 14v20M14 24h20M17 17l14 14M31 17 17 31"
        stroke="currentColor"
        strokeOpacity=".42"
        strokeWidth="2.3"
        strokeLinecap="round"
...
export function DemoNotesIcon({ className }: IconProps) {
  return (
    <IconShell className={className}>
      <path
        fill="currentColor"
        d="M14 8h17a4 4 0 0 1 4 4v23l-6-4H14a4 4 0 0 1-4-4V12a4 4 0 0 1 4-4Z"
      />
      <path
        stroke="white"
        strokeOpacity=".62"
...
/** Bilan — phare de pilotage macro */
export function ReviewIcon({ className }: IconProps) {
  return (
    <IconShell className={className}>
      <path
        d="M24 8l3.5 7h7.5l-6 5 2.5 8-7.5-5-7.5 5 2.5-8-6-5h7.5L24 8Z"
        fill="currentColor"
        opacity=".22"
      />
      <circle cx="24" cy="24" r="9" fill="currentColor" />
      <circle cx="24" cy="24" r="3.5" fill="white" fillOpacity=".72" />
      <path
        d="M24 10v5M24 33v5M10 24h5M33 24h5"
        stroke="currentColor"
        strokeOpacity=".42"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
      <path
        d="M15 15l3.5 3.5M29.5 29.5 33 33M33 15l-3.5 3.5M18.5 29.5 15 33"
        stroke="currentColor"
        strokeOpacity=".28"
        strokeWidth="1.8"
        strokeLinecap="round"
