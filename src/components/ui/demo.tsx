  ...
  return (
    <div style={{ minHeight: '100%', padding: '3rem' }}>
      ...
      >
        ...
        <span
          className="xos-numeric"
          style={{ color: 'var(--xos-text-muted)' }}
        >
          1 234,56 €
        </span>
      </header>
      ...
      >
        <GlassCard>
          <h2
            style={{
              fontFamily: 'var(--xos-font-display)',
              margin: '0 0 1rem',
            }}
          >
            Boutons — variants
          ...
          >
            ...
            <Button variant="icon" aria-label="Icône">
              ★
            </Button>
        ...
        <GlassCard>
          ...
          >
            Variante plein écran, glass appuyé — absorbe l&apos;ancien
            useComboOverlay.
          </Modal>
        </GlassCard>
        ...
        <GlassCard>
          ...
          <EmptyState
            ...
            description="Ajustez vos filtres pour voir des données."
          />
        </GlassCard>
