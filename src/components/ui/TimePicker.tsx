...
export function TimePicker({
  ...
  const triggerClasses = ["calls-input", "calls-timepicker__trigger", triggerClassName]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    <div className="calls-field calls-timepicker" ref={rootRef}>
      ...
      {open && (
        <div className="calls-timepicker__popover" role="dialog" aria-label={label}>
          <div className="calls-timepicker__columns">
            <div className="calls-timepicker__column" role="listbox" aria-label="Heures">
              {HOURS.map((h) => (
                <button
                  key={h}
                  type="button"
            ...
            <div className="calls-timepicker__column" role="listbox" aria-label="Minutes">
              {MINUTES.map((m) => (
                <button
                  key={m}
                  type="button"
