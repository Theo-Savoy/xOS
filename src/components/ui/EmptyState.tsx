...
export function EmptyState({ title, description, action }: EmptyStateProps) {
  return (
    <div className="xos-empty-state">
      <svg
        className="xos-empty-state__art"
        viewBox="0 0 160 120"
        width="160"
        height="120"
        aria-hidden="true"
      >
        <defs>
          <linearGradient id="xosEmptySky" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="currentColor" stopOpacity="0.18" />
            <stop offset="100%" stopColor="currentColor" stopOpacity="0.04" />
          </linearGradient>
        </defs>
        <rect x="8" y="12" width="144" height="96" rx="18" fill="url(#xosEmptySky)" />
