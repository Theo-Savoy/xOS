...
### Lot 3.2 — UI Weekly Perf — 🟡 *(en cours — Codex Terra medium, worktree Orca `weekly-ui`)*
...
- **Bloqué par 3 réponses Théo** (§ 9.4) : champ ARR, définition du forecast trimestre, valeurs des targets.
